...
{
	public override Vector2 InitialSize => new(1080, 540);
		...
		this(category, results)
	{
		...
		table = new DataTable<ResultColumn, ResultRow>
		{
			HeaderFont = GameFont.Medium
		};

		// Columns
		table.AddColumn(new ResultColumn(ResultColumn.ColumnType.Name, Stat.None, 250)
		{
