...
public class ExpressionTree
{
		...
		ITestManager testManager)
	{
		if (root == null)
		{
			foreach ((ITestGroup, List<ITestFunction>) filteredGroup in testManager.TestGroups.OrderBy(group => group)
		...
		foreach (ITestGroup group in testManager.TestGroups.OrderBy(group => group))
		{
