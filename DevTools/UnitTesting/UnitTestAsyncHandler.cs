...
internal static class UnitTestAsyncHandler
{
  ...
  internal static void Init()
  {
    ...
    DevHarmony.Harmony.Patch(AccessTools.Method(typeof(Root_Entry), nameof(Root_Entry.Start)),
      postfix: new HarmonyMethod(typeof(UnitTestAsyncHandler), nameof(SignalReadyToContinue)));
    DevHarmony.Harmony.Patch(AccessTools.Method(typeof(Root_Play), nameof(Root_Play.Start)),
      postfix: new HarmonyMethod(typeof(UnitTestAsyncHandler), nameof(SignalReadyToContinue)));
    DevHarmony.Harmony.Patch(
